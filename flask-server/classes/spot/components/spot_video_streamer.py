...
class SpotVideoStreamer:
    ...
    def generate(self):
        ...
        parser.add_argument("-i", "--ip", type=str, help="ip address of the device")
        parser.add_argument(
            "-o",
            "--port",
            type=int,
        ...
        while (
            keystroke != value_for_q_keystroke and keystroke != value_for_esc_keystroke
        ):
            try:
                ...
                while not images_future.done():
                    ...
                    print(keystroke)
                    if (
                        keystroke == value_for_esc_keystroke
                        or keystroke == value_for_q_keystroke
                    ):
                        sys.exit(1)
